...
import 'package:sqlite_flutter_crud/Authentication/signup.dart';
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  //Before we show the image, after we copied the image we need to define the location in pub spec.yaml
                  Image.asset(
